      ...
      <div class="card mb-2">
        ...
        <div class="row">
          ...
          <blockquote class="blockquote mb-0">
            <h3><a href="{{ route('client.task.view', $task->slug) }}">{{ $task->title }} </a><small class="text-muted posted-text"> Posted {{ $task->created_at->diffForHumans() }}</small></h3>
          ...
          <div class="col-2">
          <center>
            <a href="{{route('client.task.view', $task->slug)}}" class="add-btn" data-toggle="tooltip" data-placement="bottom" title="View Task">
